      ...
      <div className="max-w-7xl mx-auto container-padding">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-8 lg:mb-12">
          <div className="card bg-white rounded-xl shadow-lg border border-gray-100/50 p-4 lg:p-6 text-center group hover:scale-105 transition-all duration-300">
            ...
            <div className="text-xs text-green-600 mt-1 lg:mt-2 font-medium">
              This year
            </div>
          </div>
          ...
          <div className="card bg-white rounded-xl shadow-lg border border-gray-100/50 p-4 lg:p-6 text-center group hover:scale-105 transition-all duration-300">
            ...
            <div className="text-xs text-purple-600 mt-1 lg:mt-2 font-medium">
              Personal best
            </div>
          </div>
                          ...
                          >
                            ...
                            {day && hoveredDate === day.date && (
                              <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 z-50">
                                <div className="bg-gray-900 text-white text-xs rounded-lg px-3 py-2 shadow-xl min-w-max max-w-xs">
          ...
          <div className="card-elevated">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {hoveredProblems.map((problem, idx) => (
                <div key={idx} className="bg-gray-50 rounded-lg p-4 hover:bg-gray-100 transition-colors group">
